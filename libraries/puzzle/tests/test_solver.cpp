...
const std::vector<Three> threes = {
    {1, 7, 4, 6, 2, 5, 8, 3, 0, true, 24}, {3, 8, 1, 4, 6, 2, 7, 0, 5, true, 19}, {8, 5, 1, 6, 7, 3, 4, 0, 2, false, 0},
    {2, 6, 1, 0, 5, 3, 8, 7, 4, true, 23}, {6, 0, 8, 4, 7, 3, 5, 1, 2, true, 21}, {1, 8, 7, 5, 6, 2, 3, 4, 0, false, 0},
    {3, 0, 1, 8, 4, 6, 7, 5, 2, false, 0}, {4, 6, 1, 7, 8, 3, 0, 5, 2, false, 0}, {5, 1, 8, 2, 4, 7, 6, 0, 3, false, 0},
    {7, 8, 3, 4, 5, 2, 1, 6, 0, false, 0}, {1, 2, 3, 4, 5, 6, 7, 8, 0, true, 0}};
